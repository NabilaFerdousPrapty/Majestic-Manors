...
const Estates = () => {
    ...
    return (
        <div className="mt-10 text-center">
            <h2 className="text-4xl font-bold py-5 text-[#d19945]">Explore Our Exclusive Estates</h2>
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 ">
              {
                estates.map(estate=><SingleEstate estate={estate} key={estate.key}></SingleEstate>)
              }
            </div>
        </div>
    );
