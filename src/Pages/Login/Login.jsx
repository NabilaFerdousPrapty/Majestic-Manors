...
const Login = () => {
	...
	<form  action="" className="space-y-6">
		...
		<button className="block w-full p-3 text-center rounded-sm text-white bg-[#d19945]">Sign in</button>
	</form>
	...
	<p className="text-xs text-center sm:px-6 text-gray-600">Don't have an account?
		<Link to='/signup' className="underline text-[#d19945]">Sign up</Link>
	</p>
</div>
        </div>
    );
