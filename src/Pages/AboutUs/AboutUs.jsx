...
const AboutUs = () => {
  ...
  return (
    <div>
      ...
      <section style={{backgroundImage: `url('https://i.ibb.co/FVHfrjY/About.png')`}} className="py-6 bg-gray-100 text-gray-900 rounded-xl mt-5 bg-cover bg-center bg-no-repeat brightness-75">
