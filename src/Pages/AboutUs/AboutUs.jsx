...
const AboutUs = () => {
  ...
  return (
    <div>
          ...
          <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md bg-gray-50">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold sm:text-3xl">
                Welcome to Majestic Manors
              </h2>
              <p className="text-xs text-gray-600">
                By
                <span className="text-xs">Majestic Manors Team</span>
              </p>
            </div>
            <div className="text-gray-800">
              <p>
                At Majestic Manors, we specialize in providing unparalleled
                luxury real estate services. Our team of experienced
                professionals is dedicated to helping you find your dream home,
                whether it's a sprawling estate, a cozy cottage, or a modern
                condominium. We pride ourselves on our attention to detail,
      ...
      <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 bg-gray-100 text-gray-900 rounded-md">
        <div className="w-full mx-auto space-y-4 text-center">
          ...
          <h1 className="text-4xl font-bold leading-tight md:text-5xl">
            Why Choose Majestic Manors?
          </h1>
          <p className="text-sm text-gray-600 ">
            &nbsp;by&nbsp;
            <span className="underline text-[#d19945]">
        ...
        <div className="text-gray-800 text-center">
          <p>
            At Majestic Manors, we understand that buying or selling a home is
            one of the most significant financial decisions you&apos;ll make.
            That&apos;s why we go above and beyond to provide our clients with
            the highest level of service and expertise. From our extensive
            network of luxury properties to our dedicated team of real estate
            professionals, we&apos;re here to help you every step of the way.
          </p>
        </div>
      </article>

      <section className="py-6 bg-gray-100 text-gray-900 my-8 rounded-2xl">
        <div className="container mx-auto p-4 sm:p-10">
          <div className="mb-16 space-y-4 text-center">
            ...
            <div>
              ...
              ${
                tabIndex === 0 ? "bg-[#d19945] text-black" : "text-black"
              } border-[#d19945]`}
              >
                Monthly
              </button>
              <button
                ...
                className={`px-4 py-1 border-[#d19945] border rounded-r-lg ${
                  tabIndex === 1 ? "bg-[#d19945] text-black" : "text-black"
                }`}
              >
                Annually
              </button>
          ...
          <div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:max-w-full lg:gap-2 xl:gap-6 lg:grid-cols-3">
            <div className="relative z-0 flex flex-col items-center p-8  rounded-md md:border-0 border-2 border-[#d19459] border-dashed ">
              ...
              <p className="my-6 text-4xl font-bold text-[#d19945]">FREE</p>
              <ul className="flex-1 space-y-2">
                <li className="flex items-center space-x-2">
                  ...
                  <span>
                    In Free version, you can access the following features:
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <span>Suitable for personal use or small projects</span>
                </li>
              </ul>
              <Link
                to="/signup"
                className="px-4 py-2 mt-4 font-semibold uppercase border rounded-lg md:mt-12 sm:py-3 sm:px-8 border-[#d19945]"
              >
                Subscribe
              </Link>
            </div>
            <div className="relative flex flex-col items-center p-8 border-2 rounded-md border-[#d19945] bg-gray-100">
              <span className="absolute top-0 px-6 pt-1 pb-2 font-medium rounded-b-lg bg-[#d19945] text-gray-50">
                Professional
              </span>
              ...
              <ul className="flex-1 space-y-2">
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <span>Suitable for professionals and businesses</span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <Link
                to="/signup"
                className="px-8 py-3 mt-12 text-lg font-semibold uppercase rounded bg-[#d19945] text-gray-50"
              >
                Subscribe
              </Link>
            </div>
            <div className="relative z-0 flex flex-col items-center p-8  bg-gray-100 md:border-0 border-2 border-[#d19459] border-dashed rounded-md">
              ...
              <ul className="flex-1 space-y-2">
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <span>Suitable for large enterprises and organizations</span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <span>Integration options with enterprise systems</span>
                </li>
              </ul>
              <Link
                to="/signup"
                className="px-8 py-3 mt-12 text-lg font-semibold uppercase border rounded border-[#d19945]"
              >
                Subscribe
              </Link>
            </div>
      ...
      <section className=" my-8 border-2 border-gray-100 rounded-3xl">
        <h1 className="text-3xl font-bold text-center text-[#d19945]">
          Our Location
        </h1>
        <p className="text-center font-bold py-6 text-3xl">
      ...
      <section
        style={{ backgroundImage: `url('https://i.ibb.co/FVHfrjY/About.png')` }}
        className="py-6 bg-gray-100 text-gray-900 rounded-xl mt-5 bg-cover bg-center bg-no-repeat brightness-75"
      >
        <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
            ...
            <h1 className="py-2 text-3xl font-medium leading-tight title-font text-white">
              Penthouses , Villas , Apartments in the heart of the city
            </h1>
          </div>
          <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
            <button className="inline-flex items-center px-6 py-3 rounded-lg bg-[#d19945] text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <button className="inline-flex items-center px-5 py-3 rounded-lg bg-[#d19945] text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                className="fill-current w-7 h-7 text-gray-50"
